<template>
  <div>
    ...
    <div class="services_section layout_padding">
      <div class="container">
        <h1 class="services_taital"><span>Our</span> <img src="@/assets/images/common/icon-1.png"> <span style="color: #1f1f1f">Services</span></h1>
    ...
    <div class="about_section layout_padding">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div><img src="@/assets/images/common/img-2.png" class="image_2"></div>
          </div>
          <div class="col-md-6">
            <h1 class="services_taital"><span>About </span> <img src="@/assets/images/common/icon-1.png"> <span style="color: #1f1f1f">Cleaning</span></h1>
            <p class="ipsum_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,</p>
            <div class="contact_bt_1"><a href="#">READ MORE<span class="contact_padding"><img src="@/assets/images/common/contact-icon1.png"></span></a></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="choose_section layout_padding">
      <div class="container">
        <h1 class="choose_taital"><span>Why </span> <img src="@/assets/images/common/icon-1.png"> <span style="color: #1f1f1f">Choose Us</span></h1>
        ...
        <div class="choose_section_2 layout_padding">
          ...
          <div class="image_3"><img src="@/assets/images/common/img-3.png"></div>
    ...
    <div class="team_section layout_padding">
      <div class="container">
        <h1 class="choose_taital"><span>Our </span> <img src="@/assets/images/common/icon-1.png"> <span style="color: #1f1f1f">Team</span></h1>
        <p class="choose_text">Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p>
        <div class="team_section_2 layout_padding">
          <div class="container">
            <div class="images_main_1">
              <div class="row">
                <div class="col-sm-5">
                  <div class="image_4"><img src="@/assets/images/common/img-4.png"></div>
                  <h6 class="follow_text">Follow Us</h6>
                  <div class="follow_social_icon">
                    <ul>
                      <li><a href="#"><img src="@/assets/images/common/fb-icon.png"></a></li>
                      <li><a href="#"><img src="@/assets/images/common/twitter-icon.png"></a></li>
                      <li><a href="#"><img src="@/assets/images/common/linkden-icon.png"></a></li>
                      <li><a href="#"><img src="@/assets/images/common/instagram-icon.png"></a></li>
                    </ul>
                  </div>
                </div>
                <div class="col-sm-7">
            ...
            <div class="images_main">
              <div class="row">
                ...
                <div class="col-sm-5">
                  <div class="image_4"><img src="@/assets/images/common/img-5.png"></div>
                  <h6 class="follow_text">Follow Us</h6>
                  <div class="follow_social_icon">
                    <ul>
                      <li><a href="#"><img src="@/assets/images/common/fb-icon.png"></a></li>
            ...
            <div class="images_main_1">
              <div class="row">
                <div class="col-sm-5">
                  <div class="image_4"><img src="@/assets/images/common/img-6.png"></div>
                  <h6 class="follow_text">Follow Us</h6>
                  <div class="follow_social_icon">
                    <ul>
                      <li><a href="#"><img src="@/assets/images/common/fb-icon.png"></a></li>
            ...
            <div class="images_main">
              <div class="row">
                ...
                <div class="col-sm-5">
                  <div class="image_4"><img src="@/assets/images/common/img-7.png"></div>
                  <h6 class="follow_text">Follow Us</h6>
                  <div class="follow_social_icon">
                    <ul>
                      <li><a href="#"><img src="@/assets/images/common/fb-icon.png"></a></li>
...
<style>
@import "@/assets/css/common/bootstrap.min.css";
@import "@/assets/css/common/style.css";
@import "@/assets/css/common/responsive.css";
@import "@/assets/css/common/owl.carousel.min.css";
@import "@/assets/css/common/jquery.mCustomScrollbar.min.css";

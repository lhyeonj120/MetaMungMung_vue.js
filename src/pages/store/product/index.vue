...
@media (max-width: 770px) {
  ...
  .mobile-footer h3 {
    ...
    height: 50px;
    padding-top: 10px;
    background: url(http://t1.kakaocdn.net/friends/new_store/img_emoticon_181121.png)
      no-repeat 90% 0;
  ...
  .mobile-notice .notice > i {
    ...
    width: 6px;
    height: 100%;
    background: url(http://t1.kakaocdn.net/friends/new_store/ico_more_notice.png)
      no-repeat center;
  ...
  .mobile-notice .kakaotalk .kakao-btn {
    ...
    padding-left: 40px;
    background: url(http://t1.kakaocdn.net/friends/new_store/ico_kakaotalk.png)
      no-repeat 20px center #ffdd29;
  ...
  .mobile-notice .kakaotalk .friends-ico {
    ...
    width: 85px;
    height: 84px;
    background: url(http://t1.kakaocdn.net/friends/new_store/bg_talk.png)
      no-repeat;
...
.mobile-top .logo {
  ...
  height: 14px;
  font-size: 1px;
  background-image: url(https://t1.kakaocdn.net/friends/kfo-common/mo/m320/img_gnb_181002.png);
  color: transparent;
...
.top-bottom-sh {
  ...
  width: 100%;
  height: 30px;
  background: url(https://t1.kakaocdn.net/friends/kfo-common/pc/bg_head.png)
    repeat-x 0 0;
  display: none;
}
...
.top-box .top-bar .logo {
  margin-top: 13px;
  width: 182px;
  height: 19px;
  background-image: url(https://t1.kakaocdn.net/friends/kfo-common/pc/img_gnb_181002.png);
  background-repeat: no-repeat;
  margin-top: 15px;
  cursor: pointer;
  vertical-align: middle;
...
/*탑바-탑메뉴1*/
.top-box .top-bar .top-menu > ul > li > a {
  display: block;
  padding: 15px 15px;
  position: relative;
  font-size: 16px;
...
.top-box .top-bar .top-menu > ul > li:first-child > a {
  padding-left: 100px;
}

.top-bar .top-menu ul > li .bottom-bar {
  position: absolute;
  bottom: 0;
  left: 50%;
...
.top-box .top-bar .top-menu > ul > li:first-child .bottom-bar {
  width: calc(100% - 90px);
  left: 75%;
}
...
.top-bar .top-menu ul > .museum div a {
  font-weight: normal;
}

.top-bar .top-menu ul > li:hover .bottom-bar {
  display: block;
}

/*탑바-탑메뉴1-서브메뉴배경*/
.top-bar .top-menu ul > li > div {
  position: absolute;
  left: 0;
  width: 100%;
  height: 0;
...
.top-bar .top-menu ul:hover > li > div {
  border-top: 1px solid lightgray;
}

.top-bar .top-menu ul > li:hover .height-600 {
  height: 600px;
  box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1);
}

.top-bar .top-menu ul > li:hover .height-150 {
  height: 120px;
  box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1);
}

/*탑바-탑메뉴1-서브메뉴 : 서브메뉴전체(뮤지엄)*/
.top-bar .top-menu .museum div div {
  left: 10px;
  width: 400px;
  padding-top: 25px;
}

.top-bar .top-menu .museum div a {
  display: block;
...
/*탑바-탑메뉴1-서브메뉴 : 서브메뉴전체(카테고리)*/
.top-bar .top-menu div > div {
  padding-top: 1px;
}

.top-bar .top-menu .sub-menu > ul > li {
  background-color: white;
  height: 600px;
}

.top-bar .top-menu .sub-menu > ul > li:first-child {
  width: 600px;
}

.top-bar .top-menu .height-600 .sub-menu > ul > li:last-child {
  width: 580px;
...
/*서브메뉴1-1 : 왼쪽서브메뉴 세부*/
.top-menu > ul > li .sub-menu .sub-menu-1 {
}
.top-menu > ul > li .sub-menu .sub-menu-1 > li > a {
  display: block;
  height: 36px;
  padding-top: 3px;
  font-size: 16px;
...
.top-menu > ul > li .sub-menu .sub-menu-1-1 a {
  display: block;
  height: 36px;
  padding-top: 8px;
  font-size: 16px;
...
.top-menu .sub-menu .sub-menu-1-1 {
  position: absolute;
  left: 214px;
  top: 0;
  width: 385px;
...
.top-menu .sub-menu .sub-menu-1-1 > li:hover .sub-banner {
  display: block;
}

.top-menu .sub-menu .sub-menu-1-1 .sub-banner {
  position: absolute;
  bottom: 63%;
  right: 0;
  width: 169px;
...
.top-menu .sub-menu .sub-menu-1-1 .sub-banner > img {
  display: block;
  width: 100%;
  height: auto;
  border-radius: 6px;
...
.top-menu .sub-menu .sub-menu-1 .sub-menu-1-1::after {
  content: "";
  width: 25px;
  height: 599px;
  background-color: white;
...
.top-menu .sub-menu .sub-menu-1 {
  margin-top: 35px;
  margin-bottom: 10px;
  font-weight: normal;
}

.top-menu .sub-menu .sub-menu-1 li:hover > a {
  font-weight: bold;
  color: #7d7d7d;
}

.top-menu .sub-menu .sub-menu-1 > li:hover .sub-menu-1-1 {
  display: block;
}

.top-menu .sub-menu .sub-menu-1 > li:hover::before {
  content: "";
  width: 15px;
  height: 15px;
  position: absolute;
  background-color: lightgray;
  transform: translatey(5px) translatex(178px) rotate(-45deg);
}

.top-menu .sub-menu .sub-menu-1 > li:hover::after {
  content: "";
  width: 15px;
  height: 15px;
  position: absolute;
  left: 0;
  background-color: white;
  transform: translatey(-34px) translatex(180px) rotate(-45deg);
  z-index: 20;
}

.top-menu .sub-menu .sub-menu-1 > li:last-child::after {
  transform: translatey(-34px) translatex(180px) rotate(-45deg);
}
/*서브메뉴2 : 오른쪽서브메뉴 전체 */

.sub-menu li:last-child > span {
  margin-bottom: 20px;
}
...
.sub-menu .sub-menu-2 > li:nth-child(2n + 1) {
  padding-right: 300px;
}

.sub-menu .sub-menu-2 > li > a .title-character {
  display: block;
  padding-top: 11px;
  font-weight: bold;
  font-size: 16px;
...
.sub-menu .sub-menu-2 > li > a .text-character {
  display: block;
  padding-top: 14px;
  font-weight: 500;
  font-size: 6px;
...
.sub-menu .sub-menu-2 div {
  height: 100%;
}

.sub-menu .sub-menu-2 .characters {
  overflow: hidden;
  width: 74px;
  height: 100%;
}

.sub-menu .sub-menu-2 .img1 {
  background-position: -200px -540px;
}
.sub-menu .sub-menu-2 .img1 {
  background-position: -200px -540px;
}
.sub-menu .sub-menu-2 .img2 {
  background-position: -200px -650px;
}
.sub-menu .sub-menu-2 .img3 {
  background-position: -280px -540px;
}
.sub-menu .sub-menu-2 .img4 {
  background-position: -280px -650px;
}

.sub-menu .sub-menu-2 .img5 {
  background-position: -360px -540px;
}
.sub-menu .sub-menu-2 .img6 {
  background-position: -360px -650px;
}

.sub-menu .sub-menu-2 .img7 {
  background-position: -440px -540px;
}
.sub-menu .sub-menu-2 .img8 {
...
.prod-list ul > li > .state .cart {
  ...
  width: 15px;
  height: 20px;
  background: url(http://t1.kakaocdn.net/friends/new_store/ico_cart.png)
    no-repeat center;
...
.notice a .ico {
  ...
  font-size: 0;
  line-height: 0;
  background-image: url(https://t1.kakaocdn.net/friends/kfo-common/pc/ico_newfriends_v1_180920.png);
  background-repeat: no-repeat;
  vertical-align: top;
  text-indent: -9999px;
}
...
html.left-side-bar-visible,
html.left-side-bar-visible > body {
  overflow-y: hidden;
}
